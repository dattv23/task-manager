...
export const Register = () => {
      ...
      const [hidePassComfirm, setHidePassComfirm] = useState(true);
      ...
      return (
            <div className="max-w-full bg-white flex flex-1 flex-wrap relative">
                  <div className="flex-[0.3] px-8 pt-3 gap-1">
                        ...
                        <div className="mb-2 w-full flex-col justify-start items-start gap-2 inline-flex">
                              <div className="ml-2 text-gray-800 text-base font-bold font-['Gelion']">      Comfirm Password</div>
                              <div className="w-full relative flex items-center">
                                    <input type={hidePassComfirm ? "password" : "text"} className="w-full h-[50px] p-4 rounded-xl border border-gray-400" />
                                    <button className="absolute right-2 bg-gray-300 hover:bg-gray-400 rounded px-2 py-1 text-sm text-gray-600 font-mono cursor-pointer" onClick={() => setHidePassComfirm((pre) => !pre)}>Show</button>
                              </div>
                              <div className="ml-2 text-slate-500 text-xs font-normal font-['Gelion']">Upto 8 characters with an Uppercase, symbol and number</div>
                        </div>
                        ...
                        <div className='flex justify-end items-center'>
                              ...
                              <Button variant={"tetiary"} to='/login' className="text-primary text-base font-semibold font-['Poppins'] tracking-tight w-14 h-14">Log In</Button>
                        </div>
                  </div>
                  <div className="flex-[0.7] relative">
                        <div className="w-[169px] h-3/4 left-[70px] top-0 absolute bg-gradient-to-b from-sky-100 to-sky-100 shadow-inner" />
